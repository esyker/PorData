...
function init() {
  ...
  d3.csv(data_file).then((data) =>{
    ...
    dataSet = data.filter(function (d) {
      if (d.ODS == "16" && d.Símbolo != "Valor não disponível"){
        return d;
      }
    });
    ...
    var years_valid = [2018,2017,2016,2015,2014,2013,2012,2011,2010]
  ...
  for (let i = 0; i < nlist.length; i++) {
    ...
    if (nlist[i].className.includes('active')) {
      ...
      if(div_ativa == "#my_dataviz1")
      {
        ...
        var x1 = document.getElementById("container__textSub_ODS_Title8");
        var x2 = document.getElementById("container__textSub_ODS_Text8");
        var x3 = document.getElementById("container__textSub_ODS_Title1");
        var x4 = document.getElementById("container__textSub_ODS_Text1");
        var x5 = document.getElementById("imgSUB_ODS1_8");
      ...
      else if(div_ativa == "#my_dataviz4")
      {
        ...
        cleanSelect("my_select");
        var years_valid = [2020,2019,2018,2017,2016]
        populateSelect("my_select", years_valid);
        sortSelect("my_select");
        $('#my_select').val(years_valid[0]);
      ...
      else if(div_ativa == "#my_dataviz5")
      {
        ...
        cleanSelect("my_select");
        var years_valid = [2020,2019,2018,2017,2016,2015,2014,2013,2012]
        populateSelect("my_select", years_valid);
        sortSelect("my_select");
        $('#my_select').val(years_valid[0]);
      ...
      else if(div_ativa == "#my_dataviz7")
      {
        ...
        $('#my_select').val(years_valid[0]);
         ...
         d3.select("#my_dataviz7").selectAll("svg").remove();
         create_Barplot7(dataSet, false);

        var x1 = document.getElementById("container__textSub_ODS_Title6");
        var x2 = document.getElementById("container__textSub_ODS_Text6");
        var x3 = document.getElementById("container__textSub_ODS_Title7");
        var x4 = document.getElementById("container__textSub_ODS_Text7");
        var x5 = document.getElementById("imgSUB_ODS1_6");
        var x6 = document.getElementById("imgSUB_ODS1_7");
      ...
      else if(div_ativa == "#my_dataviz8")
      {
        ...
        $('#my_select').val(years_valid[0]);
         ...
         d3.select("#my_dataviz8").selectAll("svg").remove();
         create_Barplot8(dataSet, false);

        var x1 = document.getElementById("container__textSub_ODS_Title7");
        var x2 = document.getElementById("container__textSub_ODS_Text7");
        var x3 = document.getElementById("container__textSub_ODS_Title8");
        var x4 = document.getElementById("container__textSub_ODS_Text8");
        var x5 = document.getElementById("imgSUB_ODS1_7");
        var x6 = document.getElementById("imgSUB_ODS1_8");
...
change_Arrow_Paginate_Color("#00689D");
}
...
data = data.filter(function (d) {
  if (d.Title == 'Taxa padronizada de mortalidade por homicídio') {
      return d;
  }
});
...
const yLabelSize = BrowserText.getWidth('Taxa - %000', 14, 'sans-serif');
...
.style("fill", "#3A3B3C")
.attr("font-family", "sans-serif")
.text("Taxa padronizada de mortalidade por homicídio");
}  
...
data = data.filter(function (d) {
  if (d.Title == 'Proporção da população que reporta ocorrências de crime, violência e vandalismo na sua área') {
      return d;
  }
});
...
.style("fill", "#3A3B3C")
.attr("font-family", "sans-serif")
.text("Proporção da população que reporta ocorrências de crime, violência e vandalismo na sua área");
}  
...
data = data.filter(function (d) {
  if (d.Title == 'Administrações Públicas: despesa em tribunais <em>per capita</em>') {
      return d;
  }
});
...
const yLabelSize = BrowserText.getWidth('Euro - Rácio', 14, 'sans-serif');
...
svg.append("text")
  ...
  .style("fill", "#3A3B3C")
  .attr("font-family", "sans-serif")
  .text("Administrações Públicas: despesa em tribunais 'per capita'");
...
data = data.filter(function (d) {
if (d.Title == 'Percepção de independência do sistema judicial' && d['Var. Ad-hoc'] == "Percepção muito boa ou boa") {
    return d;
}
});
...
data_aux = dataSet
data_aux = data_aux.filter(function (d) {
if (d.Title == 'Percepção de independência do sistema judicial') {
    return d;
}
});
const max = d3.max(data_aux.map(d => d.Value).map(Number));
...
.style("fill", "#3A3B3C")
.attr("font-family", "sans-serif")
.text("Percepção muito boa ou boa de independência do sistema judicial");
...
data = data.filter(function (d) {
  if (d.Title == 'Índice de percepção de corrupção') {
      return d;
  }
});
...
const yLabelSize = BrowserText.getWidth('Índice', 14, 'sans-serif');
...
.style("fill", "#3A3B3C")
.attr("font-family", "sans-serif")
.text("Índice de percepção de corrupção");
...
data = data.filter(function (d) {
  if (d.Title == 'Proporção da população com confiança na Comissão Europeia') {
      return d;
  }
});
...
.style("fill", "#3A3B3C")
.attr("font-family", "sans-serif")
.text("Proporção da população com confiança na Comissão Europeia");
...
function create_Barplot7(data, update){
...
data = data.filter(function (d) {
  if (d.Title == 'Proporção da população com confiança no Banco Central Europeu') {
      return d;
  }
});
...
.selectAll("text")
 ...
 .range([ height - 40, 30]);
  ...
  if (!update) {
    ...
    d3.select("div#my_dataviz7").append("svg").append("g").attr("class", "bars");
  }



 const svg = d3
 .select("div#my_dataviz7")
 .select("svg")
 .attr("width", width)
 .attr("height", height);
...
.style("fill", "#3A3B3C")
.attr("font-family", "sans-serif")
.text("Proporção da população com confiança no Banco Central Europeu");

}  


var div = d3.select("div#my_dataviz7").append("div")	
 .attr("class", "tooltip")				
 .style("opacity", 0)
 .style("background", tooltip_background);
...
d3.select("div#my_dataviz7").select("g.xAxis").call(xAxis);
d3.select("div#my_dataviz7").select("g.yAxis").call(yAxis);

 
 
}
function create_Barplot8(data, update){
...
data = data.filter(function (d) {
  if (d.Title == 'Proporção da população com confiança no Parlamento Europeu') {
      return d;
  }
});
...
.selectAll("text")
 ...
 .range([ height - 40, 30]);
  ...
  if (!update) {
    ...
    d3.select("div#my_dataviz8").append("svg").append("g").attr("class", "bars");
  }



 const svg = d3
 .select("div#my_dataviz8")
 .select("svg")
 .attr("width", width)
 .attr("height", height);
...
.style("fill", "#3A3B3C")
.attr("font-family", "sans-serif")
.text("Proporção da população com confiança no Parlamento Europeu");
}  


var div = d3.select("div#my_dataviz8").append("div")	
 .attr("class", "tooltip")				
 .style("opacity", 0)
 .style("background", tooltip_background);
...
d3.select("div#my_dataviz8").select("g.xAxis").call(xAxis);
d3.select("div#my_dataviz8").select("g.yAxis").call(yAxis);
...
function handleMouseOver(event, d) {
  ...
  barChart6 = d3.select("div#my_dataviz7").select("svg");
  barChart6
    .selectAll("rect")
    .filter(function (b) {
      if (d.Country == b.Country) {
  ...
  barChart7 = d3.select("div#my_dataviz8").select("svg");
  barChart7
    .selectAll("rect")
    .filter(function (b) {
      if (d.Country == b.Country) {
  ...
  div.html("<strong>" + d.Country + "</strong> " + "<br>" + "<strong>" + "Euro - Rácio" + ": " +"</strong> "  +  d.Value )      
    .style('left', `${pos['x']}px`)
  ...
  div.html("<strong>" + d.Country + "</strong> " + "<strong>" + "<br>" + "índice" + ": " +"</strong> "  +  d.Value )      
    .style('left', `${pos['x']}px`)
    .style('top', `${(window.pageYOffset  + pos['y'] - 40)}px`)
  ...
  var div = d3.select("div#my_dataviz7").select("div")
  ...
  var div = d3.select("div#my_dataviz8").select("div")
  ...
  div.html("<strong>" + d.Country + "</strong> " +  "<strong>" + "<br>" + "Taxa - %000" + ": " +"</strong> "  +  d.Value )      
    .style('left', `${pos['x']}px`)
    .style('top', `${(window.pageYOffset  + pos['y'] - 40)}px`)
}
...
function dataChange(value, which) {
  ...
  d3.csv(data_file).then((data) =>{
      ...
      switch (value) {
        ...
        create_Barplot7(newData, true);
        create_Barplot8(newData, true);
